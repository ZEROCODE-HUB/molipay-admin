...
export const reportesIniciales: ReporteImpuesto[] = [
  {
    ...
    periodo: "2026-03",
    tramo: "Tramo 1",
    fechaCreacion: "2026-03-11 10:00",
    presentado: true,
    pagado: true,
    totalMovimientos: 1650,
    totalMontos: 8200000,
    totalRetenciones: 352000,
  },
  {
    id: 2,
    periodo: "2026-03",
    tramo: "Tramo 2",
    fechaCreacion: "2026-03-21 10:30",
    presentado: true,
    pagado: false,
    totalMovimientos: 1780,
    totalMontos: 8950000,
    totalRetenciones: 398000,
  },
  {
    id: 3,
    periodo: "2026-03",
    tramo: "Tramo 3",
    fechaCreacion: "2026-03-31 09:15",
    presentado: true,
    pagado: true,
    totalMovimientos: 1920,
    totalMontos: 9680000,
    totalRetenciones: 425000,
  },
  {
    id: 4,
    periodo: "2026-03",
    tramo: "Mensual",
    fechaCreacion: "2026-04-02 09:00",
    presentado: true,
    pagado: false,
    totalMovimientos: 5350,
    totalMontos: 26830000,
    totalRetenciones: 1175000,
  },
  {
    id: 5,
    periodo: "2026-02",
    tramo: "Tramo 1",
    fechaCreacion: "2026-02-11 10:32",
    presentado: true,
    pagado: true,
  ...
  },
  {
    ...
    periodo: "2026-02",
    tramo: "Tramo 2",
    fechaCreacion: "2026-02-21 15:07",
    presentado: true,
    pagado: false,
  ...
  },
  {
    ...
    periodo: "2026-02",
    tramo: "Tramo 3",
    fechaCreacion: "2026-02-28 14:00",
    presentado: true,
    pagado: true,
    totalMovimientos: 1690,
    totalMontos: 8450000,
    totalRetenciones: 365000,
  },
  {
    id: 8,
    periodo: "2026-02",
    tramo: "Mensual",
    fechaCreacion: "2026-03-02 09:00",
    presentado: false,
    pagado: false,
    totalMovimientos: 5250,
    totalMontos: 26670000,
    totalRetenciones: 1165000,
  },
  {
    id: 9,
    periodo: "2026-01",
    tramo: "Tramo 1",
    fechaCreacion: "2026-01-11 09:15",
    presentado: true,
    pagado: true,
  ...
  },
  {
    ...
    periodo: "2026-01",
    tramo: "Tramo 2",
    fechaCreacion: "2026-01-21 15:07",
    presentado: true,
    pagado: false,
    totalMovimientos: 1720,
    totalMontos: 8800000,
  ...
  },
  {
    ...
    periodo: "2026-01",
    tramo: "Tramo 3",
    fechaCreacion: "2026-01-31 16:00",
    presentado: true,
    pagado: true,
    totalMovimientos: 1580,
    totalMontos: 7900000,
    totalRetenciones: 342000,
  },
  {
    id: 12,
    periodo: "2026-01",
    tramo: "Mensual",
    fechaCreacion: "2026-02-02 09:00",
    presentado: true,
    pagado: true,
    totalMovimientos: 4955,
    totalMontos: 24810000,
    totalRetenciones: 1081000,
  },
];

...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Moli" },
      { property: "og:title", content: "Panel de Administración — Moli" },
      { property: "og:description", content: "Panel de administración de la plataforma Moli." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@100;300;400;500;600;700&family=Josefin+Sans:wght@100;300;400;600;700&family=IBM+Plex+Mono:wght@400;500&display=swap" },
    ],
  }),

...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Admin Console — Molly Money Life" },
      { name: "description", content: "Administration panel for Molly Money Life platform." },
      { name: "author", content: "Molly Money Life" },
      { property: "og:title", content: "Admin Console — Molly Money Life" },
      { property: "og:description", content: "Administration panel for Molly Money Life platform." },

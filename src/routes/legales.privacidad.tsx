      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <section className="mt-8 space-y-6 text-sm leading-relaxed text-muted-foreground">
          <div>
            ...
            <p>Moli SA, CUIT <span className="font-mono tabular-nums">30-71000000-0</span>, con domicilio en Av. Corrientes 1234, CABA, Argentina, es la responsable del tratamiento de los datos personales.</p>
          </div>
          <div>

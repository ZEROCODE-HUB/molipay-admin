...
function Page() {
  const columns: Column<TaxRecord>[] = [
    ...
    { key: "tipo", label: "Tipo", sortable: true, filterable: "enum", filterOptions: ["Débito/crédito", "Ingresos Brutos"], render: (r) => r.tipo },
    ...
    { key: "transferencia", label: "Fecha transferencia", sortable: true, filterable: "date", render: (r) => r.transferencia },
    {
      key: "estado",
      label: "Estado",
      sortable: true, filterable: "enum", filterOptions: ["Transferido", "Pendiente"],
      render: (r) => (
